...
from rlf.algos import (GAIL, PPO, BaseAlgo, BehavioralCloning, DiffPolicy, 
                       BehavioralCloningFromObs, WAIL, PWIL, GIRIL, AIRL, VAIL)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"✅ Only record these metrics: {allowed_metrics}")
    except ImportError:
        print("⚠️  Metrics filter not available, will record all metrics")
